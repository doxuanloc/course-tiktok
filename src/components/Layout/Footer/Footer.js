      ...
      <div className="footer-area pt-100">
        <div className="container">
          <div className="footer-main mb-60">
            <div className="row">
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 mr-120">
                <div className="footer-widget f-w1 mb-40">
                  <div className="footer-img">
                    ...
                    <p>
                      Những ý tưởng và kế hoạch bài học tuyệt vời dành cho học
                      viên!
                    </p>
                  </div>
              ...
              <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 mr-120">
                <div className="footer-widget f-w2 mb-40">
                  <h3>Nền Tảng Trực Tuyến</h3>
                  <ul>
                    <li>
                      <Link href="/course">
                        <a>Bài Giảng Phù Hợp</a>
                      </Link>
                    </li>
                    <li>
                      <Link href="/course">
          ...
          <div className="copyright-area pt-10">
            <div className="container">
              <div className="row">
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                ...
                <div className="col-xl-5 col-lg-5 col-md-12">
                  <div className="copyright-subcribe">
                    <form action="#" className="widget__subscribe">
                      ...
                      <button type="submit">
                        Đăng Kí<i className="fas fa-paper-plane"></i>
                      </button>
                    </form>
                  </div>
                </div>
